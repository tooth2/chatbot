...
ChatBot::~ChatBot()
{
    std::cout << "[Rule 1] ChatBot Destructor: " ;
...
{
    std::cout << "[Rule 2] ChatBot Copy Constructor: ";
...
{
    std::cout << "[Rule 3] ChatBot Copy Assignment Operator: ";
...
{
    std::cout << "[Rule 4] ChatBot Move Constructor: ";
...
{
    std::cout << "[Rule 5] ChatBot Move Assignment Operator: ";
...
void ChatBot::SetCurrentNode(GraphNode *node)
{
    ...
    _chatLogic->SendMessageToUser(answer); // send selected node answer to user
