    ...
    : wxScrolledWindow(parent, id)
{
    ...
    std::cout<< "_chatLogic : exclusive resource \n" ;
    TAG;
    _chatLogic = std::make_unique<ChatLogic>();  //_chatLogic is exclusive resource to class
...
{
    std::cout << "ChatBotPanelDialog Destructor : NaN \n" ;
    TAG;
